...
> **참고**: KISA 2026 기준 D-* 체계로 갱신되었습니다. 구 MX-* 체계 대응표는 `docs/latest_mapping_guide.md`를 참조하세요.
...
- [D-01: 기본 계정의 비밀번호, 정책 등을 변경하여 사용](#d-01-기본-계정의-비밀번호-정책-등을-변경하여-사용)
- [D-03: 비밀번호 사용 기간 및 복잡도 설정](#d-03-비밀번호-사용-기간-및-복잡도-설정)
- [D-10: 원격에서 DB 서버로의 접속 제한](#d-10-원격에서-db-서버로의-접속-제한)
- [D-02: 데이터베이스의 불필요 계정을 제거하거나 잠금설정 후 사용](#d-02-데이터베이스의-불필요-계정을-제거하거나-잠금설정-후-사용)
- [D-14: DB 주요 설정 파일 접근 권한 설정](#d-14-db-주요-설정-파일-접근-권한-설정)
- [D-14-2: secure_file_priv 설정 (D-14 세부)](#d-14-2-secure_file_priv-설정-d-14-세부)
- [[N/A] 에러 로그 활성화 (KISA 최신 가이드 대상 외)](#na-에러-로그-활성화-kisa-최신-가이드-대상-외)
- [D-25: 주기적 보안 패치 및 벤더 권고 사항 적용](#d-25-주기적-보안-패치-및-벤더-권고-사항-적용)
- [D-10-2: 네트워크 바인딩 설정 (D-10 세부)](#d-10-2-네트워크-바인딩-설정-d-10-세부)
...
- secure_file_priv 설정과 함께 사용하세요 (D-14 참조).
...
## D-14-2: secure_file_priv 설정 (D-14 세부)
...
## [N/A] 에러 로그 활성화 (KISA 최신 가이드 대상 외)
