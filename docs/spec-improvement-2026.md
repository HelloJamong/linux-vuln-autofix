...
| 우선순위 | 항목 | 분류 | 내용 |
|---|---|---|---|
| ~~MEDIUM~~ | ~~**GAP-D1**~~ | DB | ~~D-05, D-09, D-12~D-13, D-15~D-20, D-22~D-24~~ — KISA 2026 PDF 원문 확인 결과 전항목이 Oracle/MSSQL/Windows 전용. MySQL/MariaDB 비해당으로 스크립트에서 완전 제외 확정. ✅ |
| ~~LOW~~ | ~~**레거시 래퍼 잔여**~~ | 코드 품질 | U-24/25/26/29/31/32 직접 전환 완료 (6개). 잔여 35개는 후속 과제. ✅ |
| ~~LOW~~ | ~~**linux_manual_fix_guide.md**~~ | 문서 | U-53~U-57 → U-07~U-11 재매핑 완료. 신규 FTP U-53/U-56 스텁 추가. ✅ |
| ~~LOW~~ | ~~**테스트 보강**~~ | 품질 | Rocky 8.10 fixture 5개 → 10개 확장 (U-04/05/13/14/28 추가). ✅ |
