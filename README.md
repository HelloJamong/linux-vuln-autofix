...
├── linux_vulnerability_full_detailed.md  # Linux 점검 항목 상세 문서
├── mysql_spec.md                      # MySQL 점검 항목 상세 문서
...
- [Linux 취약점 점검 항목 상세](linux_vulnerability_full_detailed.md)
- [MySQL 취약점 점검 항목 상세](mysql_spec.md)

---

## 📝 라이선스

이 프로젝트는 KISA(한국인터넷진흥원)의 보안 취약점 가이드를 기반으로 작성되었습니다.
